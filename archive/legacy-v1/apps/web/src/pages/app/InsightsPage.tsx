...
import { getEvents, getCategories } from '@daypilot/lib';
  ...
  return (
    <div className="min-h-screen py-6">
      <div className="dashboard-shell">
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-[var(--muted)]">
                Your time breakdown for the past 7 days
              </p>
            </div>
        ...
        {/* Most Overloaded Day */}
        {weeklyInsights.mostOverloadedDay &&
          weeklyInsights.mostOverloadedDay.busyRatio > 0.7 && (
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-red-800 mb-2">
                    {formatDate(weeklyInsights.mostOverloadedDay.date)} was your
                    busiest day
                  </p>
                  <div className="grid grid-cols-3 gap-4 text-sm">
                    <div>
                      ...
                      <span className="font-semibold">
                        {formatDuration(
                          weeklyInsights.mostOverloadedDay.totalScheduledMinutes
                        )}
                      </span>
                    </div>
                    <div>
                      ...
                      <span className="font-semibold">
                        {Math.round(
                          weeklyInsights.mostOverloadedDay.busyRatio * 100
                        )}
                        %
                      </span>
                    </div>
                    <div>
                      ...
                      <span className="font-semibold">
                        {Math.round(
                          weeklyInsights.mostOverloadedDay.meetingLoadPercent
                        )}
                        %
                      </span>
                    </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-[var(--border)]">
                  <th className="text-left py-3 px-4 text-sm font-semibold text-[var(--text)]">
                    Day
                  </th>
                  <th className="text-right py-3 px-4 text-sm font-semibold text-[var(--text)]">
                    Scheduled
                  </th>
                  <th className="text-right py-3 px-4 text-sm font-semibold text-[var(--text)]">
                    Meetings
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-[var(--muted)]">
                          {Math.round(
                            (totalMinutes /
                              weeklyInsights.totalScheduledMinutes) *
                              100
                          )}
                          % of total time
                        </div>
