...
| Tasks UI | [x] | agent | 2026-07-21 | 2026-07-21 | `(app)/tasks` | — | Due dates, priority, projects, subtasks | — | Recurrence |
| Auth screens rebrand | [x] | agent | 2026-07-21 | 2026-07-21 | AuthProvider + login/signup | — | Password + magic link + Google UI | Needs Google OAuth client | Paste creds in Supabase |
