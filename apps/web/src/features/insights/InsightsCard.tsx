      ...
      <div className="space-y-4">
        ...
        <div>
          <div className="flex justify-between items-center mb-1">
            ...
            <span
              className={`text-sm font-bold ${getMeetingLoadColor(insights.meetingLoadPercent)}`}
            >
          ...
          <div className="h-2 bg-[var(--border)] rounded-full overflow-hidden">
            <div
              ...
              style={{
                ...
                backgroundColor:
                  insights.meetingLoadPercent > 50
                    ? '#EF4444'
                    : insights.meetingLoadPercent > 30
                      ? '#F59E0B'
                      : '#10B981',
              }}
            />
        ...
        <div>
          <div className="flex justify-between items-center mb-1">
            ...
            <span
              className={`text-sm font-bold ${getBusyRatioColor(insights.busyRatio)}`}
            >
          ...
          <div className="h-2 bg-[var(--border)] rounded-full overflow-hidden">
            <div
              ...
              style={{
                ...
                backgroundColor:
                  insights.busyRatio > 0.85
                    ? '#EF4444'
                    : insights.busyRatio > 0.7
                      ? '#F59E0B'
                      : '#10B981',
              }}
            />
        ...
        {insights.isOverbooked && (
          <div className="p-3 bg-red-50 border-l-4 border-red-500 rounded">
            ...
            <p className="text-xs text-red-700">
              You've scheduled {Math.round(insights.busyRatio * 100)}% of your
              working hours.
            </p>
          </div>
        )}
        ...
        {insights.overbookedDaysThisWeek > 0 && !insights.isOverbooked && (
          <div className="p-3 bg-yellow-50 border-l-4 border-yellow-500 rounded">
            <p className="text-xs font-semibold text-yellow-800">
              {insights.overbookedDaysThisWeek} overbooked day
              {insights.overbookedDaysThisWeek > 1 ? 's' : ''} this week
            </p>
          </div>
        )}
      </div>
